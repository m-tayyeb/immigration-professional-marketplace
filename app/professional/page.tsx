...
export default async function ProfessionalDashboard() {
  ...
  const [cases, notifications] = await Promise.all([
    prisma.case.findMany({ where: session.user.role === "PROFESSIONAL" ? { professional: { userId: session.user.id } } : {}, include: { client: true, service: true, payments: true, checklist: true }, orderBy: { updatedAt: "desc" } }),
